...
class DeepQNetwork(object):
    ...
    def __init__(self, hparams, q_fn, grad_clipping=None, scope='dqn', reuse=None):
        ...
        self.q_fn = q_fn
        self.input_shape = (hparams['batch_size'], hparams['fingerprint_length'] + 1)
        ...
        self.double_q = self.hparams['double_q']
    ...
    def _build_single_q_network(self, observations, head, state_t, state_tp1,
        ...
        # Specifically, the loss will use l1 instead of l2 loss
        # when the td error gets larger than 1.0.
